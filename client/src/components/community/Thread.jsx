...
export default function Thread({ thread, onAddComment }) {
      ...
      <div className="flex items-center mt-4 space-x-6">
        <button
          ...
          className={`flex items-center space-x-1 ${
            userVote === 'up' ? 'text-[#ff8643]' : 'text-gray-600 hover:text-[#ff8643]'
          }`}
        ...
        <button
          ...
          className={`flex items-center space-x-1 ${
            userVote === 'down' ? 'text-[#ff8643]' : 'text-gray-600 hover:text-[#ff8643]'
          }`}
        ...
        <button
          onClick={handleLike}
          className={`flex items-center space-x-1 ${
            isLiked ? 'text-[#f59e00]' : 'text-gray-600'
          } hover:text-[#f59e00]`}
        >
          <FiHeart />
          <span>{likes}</span>
        ...
        <button
          ...
          className="flex items-center space-x-1 text-gray-600 hover:text-[#ff8643]"
        >
          <FiMessageSquare />
