      ...
      <div className="flex flex-col items-center justify-center text-center px-6 py-16">
        ...
        <div className="relative flex items-center mt-6 w-full max-w-xl">
          <input
            ...
            className="w-full px-6 py-3 text-lg border border-orange-400 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-400"
          />
        ...
        <div className="mt-6">
          ...
          <div className="flex flex-wrap gap-3 mt-2">
            {["Software Engineer", "Data Analyst", "Product Manager", "UI/UX Designer"].map((career) => (
              <span
                key={career}
                onClick={() => setSearchText(career)} 
                className="px-4 py-2 text-sm bg-gray-100 rounded-full cursor-pointer hover:bg-gray-200 transition"
              >
                {career}
              </span>
            ))}
